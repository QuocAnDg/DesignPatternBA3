...
public class MainClient {
	public static void main(String[] args) throws IOException {
		File file = new File("C:\\Users\\quoca\\Desktop\\DesignPatternBA3\\DesignPatternBA3\\ex8\\cc.txt");
		Generateur generateur = new AmExGenerateur(new DiscoverGenerateur(new DinersClubGenerateur(new MasterCardGenerateur(new VisaGenerateur(null)))));
		try {
