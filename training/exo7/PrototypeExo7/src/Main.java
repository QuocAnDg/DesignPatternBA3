public class  Main {
  ...
  public static void main(String[] args) {
    ...
    Robot robot1 = new RobotImpl.Builder("grosseBerta")
        .canon(10)
        .shield(2)
        .freq(100)
        .build();
    ...
    Robot robot2 = new RobotImpl.Builder("Tank")
            .canon(9)
            .shield(3)
            .freq(90)
            .build();
    ...
    PrototypeFlyweight prototypeFlyweight = new PrototypeFlyweight();
    prototypeFlyweight.put("grosseBerta", robot1);
    prototypeFlyweight.put("Tank", robot2);
    Robot robot3 = prototypeFlyweight.create("grosseBerta");
    Robot robot4 = prototypeFlyweight.create("Tank");


    PatternRobots.fight(robot3,robot4);
