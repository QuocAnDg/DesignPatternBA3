...
import validation.DinersGenerateur;
...
public class MainClient {
	public static void main(String[] args) throws IOException {
		...
		Generateur generateur = new AmExGenerateur(new DiscoverGenerateur(new DinersGenerateur(new MasterCardGenerateur(new VisaGenerateur(null)))));
		try {
